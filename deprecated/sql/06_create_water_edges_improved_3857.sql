...
-- :connectivity_check_enabled - Whether to enable graph connectivity verification (default: true)
-- :max_crossing_distance - Maximum distance for water crossings (default: 2000)
...
FROM 
    river_points rp1
WHERE 
    ST_Distance(rp1.point, rp1.centroid) < :max_crossing_distance / 2;
...
FROM 
    lake_points lp1
WHERE 
    ST_Distance(lp1.point, lp1.centroid) < :max_crossing_distance;
...
BEGIN
    ...
    IF :connectivity_check_enabled THEN
