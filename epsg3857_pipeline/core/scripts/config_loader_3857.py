...
# Configure logging
logger = get_logger('config_loader_3857')
    ...
    def load_config(self):
        ...
        try:
            ...
            try:
                ...
                # If not found, try relative to the script's location
                script_dir = Path(__file__).parent.resolve()
                config_path = script_dir.parent.parent / 'config' / os.path.basename(self.config_file)
                logger.info(f"Trying alternative path: {config_path}")
