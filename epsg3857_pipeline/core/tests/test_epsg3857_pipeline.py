...
# Configure logging
logger = get_logger('test_epsg3857_pipeline', log_file='epsg3857_pipeline/logs/test_epsg3857_pipeline.log')
...
def test_export_slice():
    ...
    return run_command(
        "python epsg3857_pipeline/core/scripts/export_slice.py --lon -93.63 --lat 41.99 --minutes 60 --outfile test_slice.graphml",
        "Export graph slice"
    )
