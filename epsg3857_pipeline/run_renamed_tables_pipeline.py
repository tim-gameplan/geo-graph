#!/usr/bin/env python3
"""
Wrapper script that redirects to the renamed tables pipeline in the pipelines directory.
...
pipeline_script = script_dir / "pipelines" / "run_renamed_tables_pipeline.py"
