...
-- 5.0 - Default speed in m/s (default: 5.0)
-- 0.2 - Speed factor for water edges (default: 0.2)
-- 0.8 - Speed factor for uphill edges (default: 0.8)
-- 1.2 - Speed factor for downhill edges (default: 1.2)
...
SELECT 
    ...
    CASE
        WHEN elevation_change > 0 THEN 0.8
        WHEN elevation_change < 0 THEN 1.2
        ELSE 1.0
    END AS speed_factor,
    CASE
